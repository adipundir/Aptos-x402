...
- Identity registration (DB)
- Agent Cards with metadata
- Reputation scores and feedback
- Task validation
- On-chain NFT minting (requires `ARC8004_ONCHAIN_ENABLED=true`) - not included
- On-chain verification badge (requires admin) - not included
...
**See: [ARC-8004 Self-Hosting Guide](/docs/guides/arc8004-self-hosting)**
